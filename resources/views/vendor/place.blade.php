    	...
    	<div class="container-fluid">
    		<div class="row">
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/h0.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="#">Hotel Middle Path & Spa</a></h3>
		    						<p class="rate">
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
    						...
    						<p>Set just a 5-minute walk from the beautiful Phewa Lake, Hotel Middle Path & Spa offers clean and comfortable rooms with views. </p>
    						<hr>
    						<p class="bottom-area d-flex">

                            <center>	<span class="ml-auto"><a href="#">Book Now</a></span></center>
    						</p>
    					</div>
    				</div>
    			</div>
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/h1.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="#">Hotel White Himal</a></h3>
		    						<p class="rate">
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
    						...
    						<p>Hotel White Himal provides accommodations with a restaurant, free private parking, a bar and a shared lounge. </p>
    						<hr>
    						<p class="bottom-area d-flex">
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					...
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="#">Hotel Fewa Dream</a></h3>
		    						<p class="rate">
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
    						...
    						<p>Hotel fewa Dream provides accommodations with a restaurant, free private parking, a bar and a shared lounge. </p>
    						<hr>
    						<p class="bottom-area d-flex">
                            <center>	<span class="ml-auto"><a href="#">Book Now</a></span></center>
    						</p>
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					...
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="#">Hotel Lake Shore</a></h3>
		    						<p class="rate">
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
    						...
    						<p>Hotel Lake Shore provides accommodations with a restaurant, free private parking, a bar and a shared lounge. </p>
    						<hr>
    						<p class="bottom-area d-flex">
                            <center>	<span class="ml-auto"><a href="#">Book Now</a></span></center>
    						</p>
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					...
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="#">Himalayan crown lodge</a></h3>
		    						<p class="rate">
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
		    							<i class="icon-star"></i>
    						...
    						<p>Himalayan crown lodge provides accommodations with a restaurant, free private parking, a bar and a shared lounge. </p>
    						<hr>
    						<p class="bottom-area d-flex">
